      ...
      <div className="Compras">
        ...
        <div class="row">
                  ...
                  <article class="box box-product">
                    <div class="box-shadow">
                      <div class="box-shadow-inner">
                        ...
                        <div class="_holder">
                          <div class="box-image">
                            <a class="_content" title="">
                              <img id="imagen" class="image-main-variant"  alt="" title="" />
                            </a>
                          </div>
                        </div>
                    ...
                    <div class="box-caption text-center">
                      ...
                      <div class="price price-discount"><span id="precio"></span></div>
          ...
          <div class="wrapper col-5">
            ...
            <ul id="carrito" class="list-group" style={{overflowY: 'scroll',height:'300px'}}></ul>
            <hr></hr>

            <p class="text-right">Total: <span id="total"></span></p>
            <p class="text-right">Cantidad Total: <span id="cantidadtotal"></span></p>
            ...
            <table >
              ...
              <tr>
                ...
                <td width="2%">:</td>
                <td><a class="btn btn-primary">Recargar</a></td>
              </tr>
              <tr>
                <th width="30%">Proceso</th>
                <td width="2%">:</td>
                <td><a class="btn btn-success">Realizar Compra</a></td>
              </tr>
    ...
    $(document).ready(function () {
      if ($(".carousel-bazaar").hasClass('is-on') === false) {
        $(".carousel-bazaar").slick({
          lazyLoad: "ondemand",
          slidesToShow: data.length%2===0 && data.length>1 ? data.length/2:Math.trunc(data.length/3),
          slidesToScroll: 2,
          dots: true,
